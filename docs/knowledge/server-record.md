...
![ssh没有显示用户名](http://reyshieh.com/assets/sshnoshowusername.png)
...
![nginx配置过程1](http://reyshieh.com/assets/nginxconfig1.png)

![nginx配置过程2](http://reyshieh.com/assets/nginxconfig2.png)

第二步

> make

![nginx安装make](http://reyshieh.com/assets/nginxinstallmake.png)

第三步

> make install

![nginx安装make_install](http://reyshieh.com/assets/nginxinstallmake_install.png)

第四步，检查安装路径

> whereis nginx

![nginx安装检查](http://reyshieh.com/assets/nginxinstallcheck.png)
...
![nginx开机自启动](http://reyshieh.com/assets/nginxautostart.png)
...
![0端口访问一直不](http://reyshieh.com/assets/80portnotwork.png)
...
![http服务器上配置mod_ssl](http://reyshieh.com/assets/httpconfmod_ssl.png)
...
![http服务器上配置mod_ssl-删除秘钥中的密码](http://reyshieh.com/assets/httpconfmod_ssl-delete.png)
...
![http服务器上配置公钥](http://reyshieh.com/assets/httpconfigpublickey.png)
...
![http服务器上建立服务器证书](http://reyshieh.com/assets/httpsetupcert.png)
...
![cerbot报错1](http://reyshieh.com/assets/cerboterror1.png)

解决办法

![cerbot报错1-解决方案](http://reyshieh.com/assets/cerboterror1-solve.png)

增加一个只对主域名做解析的dns配置

接下来成功了

![cerbot 成功](http://reyshieh.com/assets/cerbot-success.png)

但在启动nginx时又报了异常

![https nginx 配置报错](http://reyshieh.com/assets/httpsnginxconfigerror.png)

![https nginx 配置报错-异常信息](http://reyshieh.com/assets/httpsnginxconfigerror-catch.png)
...
![解决安装的nginx不支持https的问题](http://reyshieh.com/assets/solvenginxnotsupporthttps.png)
...
![解决安装的nginx不支持https的问题-过程](http://reyshieh.com/assets/solvenginxnotsupporthttps-process.png)
