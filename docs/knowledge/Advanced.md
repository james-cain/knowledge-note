...
11.MessageChannel（ChannelPlate.js）（优先级三）
...
- <https://github.com/kamranahmedse/design-patterns-for-humans>（优先级一）
- <https://github.com/leonardomso/33-js-concepts>（优先级一）
- https://github.com/stephentian/33-js-concepts（优先级一）
- 《高性能Javascript》
- 《你不知道的Javascript》
...
- <https://github.com/phodal/microfrontends>（优先级一）
